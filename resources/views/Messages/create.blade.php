...
<div class="row">
	<div class="col-md-4 col-md-offset-4">
		{!! Form::open(array('route' => 'comments.store', 'autocomplete' => 'off')) !!}
			...
			<div class="search" id="searchCity" autocomplete="off">
			...
			@include('Partials._sportsList', array('className' => 'findLeagueFilters', 'showGeneral' => true, 'sport' => null))

			{{ Form::label('password', 'Password (This will be used to edit your message in the future)', array('class' => 'addLeagueText', 'autocomplete' => 'off')) }}
